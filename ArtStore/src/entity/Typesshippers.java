...
public class Typesshippers {
    ...
    @OneToOne
    private Typesshippers typesshippers;
    public Typesshippers(){};
    public Typesshippers(int shipperId){this.shipperId=shipperId;}
    public Typesshippers(int shipperId,String shipperName,String shipperDescription,String shipperAvgTime,int shipperClass,BigDecimal shipperBaseFee,BigDecimal shipperWeightFee){
    ...
    public boolean equals(Object o) {
        ...
        Typesshippers that = (Typesshippers) o;
